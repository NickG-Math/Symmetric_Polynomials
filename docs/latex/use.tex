...
std::cout << TCB(r) << "\n";
\end{DoxyVerb}
 This sets {\ttfamily r} to be $2x_1y_1+2x_2y_2$, transforms it into $\gamma_{s,j}$ variables and prints the result\+:
...
If we perform the transformation again we get the original polynomial\+: \begin{DoxyVerb}std::cout << TCB(TCB(r)) << "\n";
\end{DoxyVerb}
 prints $2x_1y_1+2x_2y_2$.

We note that the argument {\ttfamily 2} in the constructor of {\ttfamily TCB} is half the number of variables $x_1,x_2,y_1,y_2$.
