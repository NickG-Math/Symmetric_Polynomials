...
When we have the \char`\"{}half idempotent relation\char`\"{}, the generators are $\alpha, c_i, \gamma_{s,t}$ (see \mbox{\hyperlink{math}{The Math}}) or {\ttfamily Idem}, {\ttfamily Chern\mbox{[}i\mbox{]}} and {\ttfamily Twisted\+Chern\mbox{[}s\mbox{]}\mbox{[}t\mbox{]}} respectively as they are used in the program. We order them as $\alpha,c_1,...,c_n, \gamma_{1,1},...,\gamma_{1,n-1},\gamma_{2,1},...,\gamma_{n-1,1}$ in this order. To get the original indexing on the $\gamma$ elements we use {\ttfamily std\+::map$<$std\+::pair$<$int,int$>$,int$>$ Twisted\+Chern\+\_\+indexer} eg \begin{DoxyVerb}std::cout << TwistedChern_indexer[std::make_pair<int,int>(1,2)];
\end{DoxyVerb}


prints {\ttfamily 1} since {\ttfamily Twisted\+Chern\mbox{[}1\mbox{]}} corresponds to $\gamma_{1,2}$.
...
sets {\ttfamily poly} to be $x_1y_1+x_2y_2$, computes the decomposition of {\ttfamily poly} into {\ttfamily Idem,Chern,Twisted\+Chern}, stores it into {\ttfamily dec} and prints the decomposition as {\ttfamily 2$\ast$a$\ast$c\+\_\+1 + -\/2$\ast$b\+\_\+\{1,1\}} reflecting \$\$x\+\_\+1y\+\_\+1+x\+\_\+2y\+\_\+2=2\textbackslash{}alpha c\+\_\+1-\/2\textbackslash{}gamma\+\_\+\{1,1\}\$\$

The class {\ttfamily decomposition\+\_\+half\+\_\+idempotent$<$rational$>$} stores and computes the expression of a polynomial on variables $x_i,y_i$ as a polynomial on the $\alpha,c_i,\gamma_{s,j}$.

To print the relations amongst $\alpha,c_i,\gamma_{s,j}$ simply use\+: print\+\_\+half\+\_\+idempotent\+\_\+relations$<$rational$>$(3);
